...
import ar.edu.utn.frbb.tup.Controlador.Precesadores.ProcesadorDatosOperacion;
...
public class ControladorOperacion {
    ...
    public ResponseEntity<Movimiento> depositar(@RequestBody Map<String, String> datosOperacion) throws ExcepcionCuentaBancariaNoExiste, ExcepcionDatosInvalidos {
        Map<String, String> datos = ProcesadorDatosOperacion.datosOperacion(datosOperacion);
